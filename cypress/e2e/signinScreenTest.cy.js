describe("SigninScreen", () => {
  ...
  it("Should navigate to welcomeScreen if the user signup successfully", () => {
    cy.visit("http://192.168.178.182:8081");
    ...
    const testDateOfBirth = "Tue Feb 01 1988";
    const testPassword = "Password1234!";
    const testConfirmPassword = "Password1234!";
    ...
    // Verify that the user is in the welcome page check the welcome-image
